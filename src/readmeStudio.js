...
const README_STUDIO_VIEW_TYPE = "colins-readme-studio.view";
...
function registerReadmeStudio(context) {
  context.subscriptions.push(vscode.commands.registerCommand("colins-readme-studio.open", openReadmeStudio));
}
